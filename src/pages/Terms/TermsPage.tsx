    ...
    <>
      ...
      >
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          {/* رأس الصفحة - Header باللون البرتقالي المتدرج */}
                ...
                <nav className="space-y-1">
                  {termsData.map((section) => (
                    ...
                    >
                      ...
                      {/* يعرض الجزء الأول من العنوان للاختصار في السايدبر */}
                    </a>
                  ))}
                </nav>
              </div>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      {section.content.map((paragraph, idx) => {
                        // تمييز الملاحظة الهامة الأولى والتنبيه الخاص بـ الاستهلاك الفردي
                        const isNotice =
                          paragraph.includes("Please note:") ||
                          paragraph.startsWith("This document constitutes");
                        return (
                          <p
                            key={idx}
